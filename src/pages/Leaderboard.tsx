  ...
  return (
    <div className="space-y-8 p-4 md:p-8 max-w-7xl mx-auto">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {(viewMode === 'students' ? filteredData[1] : classLeaderboard[1]) && (
                <motion.div 
                  onClick={() => setSelectedEntry(viewMode === 'students' ? filteredData[1] : classLeaderboard[1])}
              ...
              {(viewMode === 'students' ? filteredData[0] : classLeaderboard[0]) && (
                <motion.div 
                  onClick={() => setSelectedEntry(viewMode === 'students' ? filteredData[0] : classLeaderboard[0])}
                  initial={{ opacity: 0, rotateX: -20, y: 50 }}
                  animate={{ opacity: 1, rotateX: 0, y: 0 }}
              ...
              {(viewMode === 'students' ? filteredData[2] : classLeaderboard[2]) && (
                <motion.div 
                  onClick={() => setSelectedEntry(viewMode === 'students' ? filteredData[2] : classLeaderboard[2])}
                  initial={{ opacity: 0, rotateX: -20, y: 50 }}
                  animate={{ opacity: 1, rotateX: 0, y: 0 }}
              ...
              <div className="divide-y divide-slate-50 dark:divide-slate-800/50">
                {viewMode === 'students' ? (
                  ...
                  filteredData.slice(3).map((student: any, index: number) => (
                    <div 
                      key={student.id} 
                      onClick={() => setSelectedEntry(student)}
                      className={cn(
                        "flex items-center justify-between p-6 transition-colors cursor-pointer",
                  ...
                  classLeaderboard.slice(3).map((cls: any, index: number) => (
                    <div 
                      ...
                      className="flex items-center justify-between p-6 transition-colors hover:bg-slate-50/50 dark:hover:bg-slate-800/50 cursor-pointer"
                    >
                      <div className="flex items-center gap-6">
                        <div className="w-8 text-center">{getRankIcon(index + 4)}</div>
                        <div className="flex items-center gap-4">
      ...
      <LeaderboardDetailModal 
        ...
        type={viewMode === 'students' ? 'student' : 'class'} 
