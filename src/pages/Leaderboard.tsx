    ...
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          {lastUpdated && (
            <div className="flex items-center gap-4 mt-1">
              ...
              <button
                ...
                className="text-[10px] text-blue-600 dark:text-blue-400 font-bold uppercase tracking-wider hover:text-blue-800 dark:hover:text-blue-300 disabled:text-slate-400 dark:disabled:text-slate-600"
              >
        ...
        {!loading && leaderboard.length > 0 && (
          <div className="flex items-center gap-2 bg-white dark:bg-slate-900 p-1.5 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm overflow-x-auto no-scrollbar">
            {classes.map(c => (
              <button
                key={c}
                onClick={() => setFilter(c)}
                className={cn(
                  ...
                  filter === c ? "bg-blue-500 text-white shadow-md dark:shadow-none" : "text-slate-500 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800"
                )}
              >
                {c}
              </button>
      ...
      {loading ? (
        ...
        <div className="bg-white dark:bg-slate-900 rounded-[32px] p-12 text-center border border-slate-100 dark:border-slate-800 shadow-sm">
          ...
          <p className="text-slate-500 dark:text-slate-400 max-w-xs mx-auto">Start participating in activities to earn points and appear on the leaderboard!</p>
        </div>
      ) : (
        <>
          {/* Top 3 Podium */}
        ...
        {filteredData[1] && (
          ...
          >
            ...
            <h3 className="font-bold text-slate-900 dark:text-white flex items-center justify-center gap-1">
              ...
              {filteredData[1].wellnessBadge && <span title="Wellness Badge"><ShieldCheck size={16} className="text-emerald-500 fill-emerald-100 dark:fill-emerald-900/30" /></span>}
            </h3>
        ...
        {filteredData[0] && (
          ...
          >
            ...
            <h3 className="text-xl font-bold text-slate-900 dark:text-white flex items-center justify-center gap-1">
              ...
              {filteredData[0].wellnessBadge && <span title="Wellness Badge"><ShieldCheck size={20} className="text-emerald-500 fill-emerald-100 dark:fill-emerald-900/30" /></span>}
            </h3>
        ...
        {filteredData[2] && (
          ...
          >
            ...
            <h3 className="font-bold text-slate-900 dark:text-white flex items-center justify-center gap-1">
              ...
              {filteredData[2].wellnessBadge && <span title="Wellness Badge"><ShieldCheck size={16} className="text-emerald-500 fill-emerald-100 dark:fill-emerald-900/30" /></span>}
            </h3>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="font-bold text-slate-900 dark:text-white flex items-center gap-1">
                      {student.fullName} 
                      {student.wellnessBadge && <span title="Wellness Badge"><ShieldCheck size={14} className="text-emerald-500 fill-emerald-100 dark:fill-emerald-900/30" /></span>}
