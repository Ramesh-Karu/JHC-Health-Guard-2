      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <button 
            ...
            className="w-12 h-12 bg-blue-500 text-white rounded-2xl flex items-center justify-center shadow-lg shadow-blue-200 hover:bg-blue-600 transition-all active:scale-95"
          >
            <Plus size={24} />
          </button>
        </div>
        ...
        <div className="relative group">
          ...
          <input 
            ...
            className="w-full pl-12 pr-4 py-3.5 bg-white border border-slate-100 rounded-2xl focus:ring-2 focus:ring-blue-500 outline-none transition-all shadow-sm"
          />
        </div>
              ...
              <div className="p-5 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <button 
                    ...
                    className="w-10 h-10 rounded-xl bg-slate-100 overflow-hidden border border-slate-50 hover:ring-2 hover:ring-blue-500 transition-all"
                  >
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <button 
                        onClick={() => handleViewUser(post.authorId)}
                        className="text-sm font-bold text-slate-900 hover:text-blue-500 transition-colors"
                      >
                        {post.authorName}
                      </button>
                      {post.category && (
                    ...
                    {post.poll.options.map((option) => {
                      ...
                      return (
                        <button
                          ...
                          className="w-full relative h-12 rounded-xl overflow-hidden border border-slate-100 group/opt"
                        >
                          <motion.div 
                            initial={{ width: 0 }}
                            ...
                            className={cn(
                              ...
                              hasVoted ? "bg-blue-500/10" : "bg-slate-50"
                            )}
                          />
                          <div className="absolute inset-0 px-4 flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <span className={cn(
                                ...
                                hasVoted ? "text-blue-600" : "text-slate-700"
                              )}>
                                {option.text}
                              </span>
              ...
              <div className="px-6 py-4 flex items-center justify-between border-t border-slate-50 bg-slate-50/30">
                  ...
                  {REACTION_TYPES.map((reaction) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        />
                        {count > 0 && (
                          <span className={cn(isReacted ? "text-slate-900" : "text-slate-500")}>
                            {count}
                          </span>
                        )}
                      </button>
                ...
                <div className="flex items-center gap-2">
                  <button 
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-bold text-slate-500 hover:bg-white hover:text-blue-500 transition-all"
                  >
                    <MessageCircle size={18} />
                    {post.commentsCount}
                  </button>
                  <button className="p-2 text-slate-400 hover:text-blue-500 hover:bg-white rounded-full transition-all">
                    <Share2 size={18} />
                  </button>
                </div>
              </div>
          ...
          <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-md">
            ...
            >
              <div className="p-6 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
                ...
                <button onClick={() => setIsModalOpen(false)} className="p-2 hover:bg-white rounded-xl text-slate-500 transition-colors">
                  <X size={20} />
                </button>
              </div>
                ...
                <div className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl border border-slate-100">
                  <div className="flex items-center gap-3">
                    <div className={cn(
                      ...
                      isPollMode ? "bg-blue-500 text-white" : "bg-white text-slate-400"
                    )}>
                      <BarChart2 size={20} />
                    </div>
                    <div>
                      <p className="text-sm font-bold text-slate-900">Create a Poll</p>
                  ...
                  <button 
                    ...
                    className={cn(
                      ...
                      isPollMode ? "bg-blue-500" : "bg-slate-200"
                    )}
                  >
                    <div className={cn(
                ...
                {isPollMode ? (
                  <div className="space-y-4 animate-in fade-in slide-in-from-top-2">
                    <input 
                      ...
                      className="w-full px-5 py-3.5 bg-slate-50 border border-slate-100 rounded-2xl focus:ring-2 focus:ring-blue-500 outline-none font-bold text-slate-900"
                    />
                    <div className="space-y-2">
                      {pollData.options.map((opt, idx) => (
                        <input 
                          ...
                          className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none text-sm"
                        />
                      ))}
                  ...
                  <textarea 
                    ...
                    className="w-full h-40 p-5 bg-slate-50 border border-slate-100 rounded-2xl focus:ring-2 focus:ring-blue-500 outline-none resize-none text-slate-700 leading-relaxed"
                  />
                )}
                ...
                <div className="space-y-4">
                  <div className="relative group">
                    ...
                    <input 
                      ...
                      className="w-full pl-12 pr-4 py-3.5 bg-slate-50 border border-slate-100 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none transition-all"
                    />
                  </div>
                </div>

                <button type="submit" className="w-full py-4 bg-blue-500 text-white rounded-2xl font-bold hover:bg-blue-600 shadow-lg shadow-blue-200 transition-all active:scale-[0.98]">
                  Share Post
                </button>
              </form>
            </motion.div>
        ...
        {selectedPost && (
          <div className="fixed inset-0 z-[60] flex items-end sm:items-center justify-center p-0 sm:p-4 bg-slate-900/40 backdrop-blur-md">
            <motion.div 
              ...
              animate={{ y: 0 }}
              exit={{ y: "100%" }}
              className="bg-white rounded-t-[32px] sm:rounded-[32px] w-full max-w-lg h-[85vh] sm:h-[80vh] flex flex-col shadow-2xl overflow-hidden"
            >
              <div className="p-6 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
                <div className="flex items-center gap-3">
                ...
                <button onClick={() => setSelectedPost(null)} className="p-2 hover:bg-white rounded-xl text-slate-500 transition-colors">
                  <X size={20} />
                </button>
              </div>
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-6 bg-slate-50/30">
                {comments.map((comment) => (
                  <div key={comment.id} className="flex gap-4">
                    <div className="w-9 h-9 rounded-xl bg-slate-100 overflow-hidden flex-shrink-0 border border-slate-50">
                ...
                {comments.length === 0 && (
                  <div className="flex flex-col items-center justify-center py-20 text-center space-y-4">
                    <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center shadow-sm">
                      <Smile className="text-slate-200" size={32} />
                    </div>
                    <div>
                      <h3 className="text-slate-900 font-bold">No comments yet</h3>
              ...
              <div className="p-6 border-t border-slate-100 bg-white">
                <form onSubmit={handleAddComment} className="flex gap-2">
                  <input 
                    ...
                    className="flex-1 px-5 py-3.5 bg-slate-50 border border-slate-100 rounded-2xl focus:ring-2 focus:ring-blue-500 outline-none transition-all"
                  />
                  <button type="submit" className="p-3.5 bg-blue-500 text-white rounded-2xl hover:bg-blue-600 shadow-lg shadow-blue-100 transition-all active:scale-90">
                    <Send size={20} />
                  </button>
                </form>
              </div>
              ...
              <div className="px-8 pb-8">
                <div className="relative -mt-12 mb-6">
                  <div className="w-24 h-24 rounded-[32px] bg-white p-1.5 shadow-xl">
                    <div className="w-full h-full rounded-[26px] bg-slate-100 overflow-hidden border border-slate-50">
                  ...
                  {viewingUser.role === 'admin' && (
                    <div className="absolute bottom-0 left-20 bg-blue-500 text-white p-1.5 rounded-full border-4 border-white">
                ...
                <div className="space-y-1 mb-6">
                  <h2 className="text-2xl font-bold text-slate-900">{viewingUser.fullName}</h2>
                  <p className="text-slate-500 font-medium">@{viewingUser.username}</p>
                ...
                <button 
                  onClick={() => setViewingUser(null)}
                  className="w-full mt-8 py-4 bg-slate-900 text-white rounded-2xl font-bold hover:bg-slate-800 transition-all active:scale-[0.98]"
                >
                  Close Profile
                </button>
              </div>
